...
function AreaChart({ filter, intervalTime, onChange, eventData }) {
    ...
    return (
        <Spin spinning={fetching} style={{ width: '100%' }}>
            ...
            <LarkMapChart height={640} data={viewData} flydata={flydata} placeholder={error?.message} onEnterArea={onEnterArea} />
        </Spin>
    );
}
